...
local ltime = tonumber(cTime) * 2
local atime = rand..ltime
print("ts" .. ts)
print("cTime:" .. string.sub(tostring(ts),3))
print('ltime:'.. ltime)
print('atime:'.. atime)
...
function transcoder.hello4()
    local ts = os.time({year=2022, month=4, day=16})
    print('os1'..os.time({year=2022, month=4, day=14}))
    print('os2'..os.time())
    print('os3'..os.time({year=2022, month=4, day=16}))
    print('os3'..os.time({year=2022, month=4, day=17}))
    print('os3'..os.time({year=2022, month=4, day=18}))
    print('os3'..os.time({year=2022, month=4, day=19}))
    print('os3'..os.time({year=2022, month=4, day=20}))
    local rand = 1
    local codeRand = 7
    local codeArr = {
        {'u','t','k','q','a','b','r','e','i','w'},
